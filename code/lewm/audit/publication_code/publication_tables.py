...
def full_appendix(interventions, main):
    ...
    for kind in ['transport', 'budget', 'ablation', 'horizon']:
        ...
        for metric, suffix, caption in [('success_percent', 'success', 'Success (\\%)'), ('mean_pred_blocks', 'work', 'Mean predicted five-action blocks per episode, including early stopping')]:
            rows = []
